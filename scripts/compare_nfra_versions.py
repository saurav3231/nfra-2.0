...
Writes JSON (utf-8) to nfra_31_vs_32.json and prints an ASCII table.
Run locally for a smoke check; run on Kaggle T4 for the real comparison.

Usage:
  python scripts/compare_nfra_versions.py
  NFRA_STEPS=600 NFRA_DATA=wikitext2 python scripts/compare_nfra_versions.py
"""
...
from nfra.benchmark.compare import evaluate, count_params
